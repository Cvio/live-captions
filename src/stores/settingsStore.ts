...
const settingUpdaters: {
  ...
  speak_aloud: (value) => commands.changeSpeakAloudSetting(value as boolean),
  tts_endpoint: (value) => commands.changeTtsEndpointSetting(value as string),
  tts_language: (value) => commands.changeTtsLanguageSetting(value as string),
