...
#[tauri::command]
#[specta::specta]
pub fn change_speak_aloud_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.speak_aloud = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_tts_endpoint_setting(app: AppHandle, endpoint: String) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.tts_endpoint = endpoint;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_tts_language_setting(app: AppHandle, language: String) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
